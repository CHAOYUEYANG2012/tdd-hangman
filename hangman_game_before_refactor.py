...
def game_process(secret_word):
    ...
    while not get_number_of_wrong_guesses(secret_word, guesslist) == 6:
        ...
        life = " {} left".format(
            6 - get_number_of_wrong_guesses(secret_word, guesslist))
...
def main():
    ...
    title_lines = get_title_lines(6, secret_word)

    print(title_lines)

    result = game_process(secret_word)
